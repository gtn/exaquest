...
class autofill_helper_form extends \moodleform {
    ...
    public function create_autocomplete_multi_select_html($autocompleteoptions, $id=null, $popuptype=null) {
        $options = array(
            'multiple' => true,
        );
        ...
        // ==> needs to be unique
        $element = $this->_form->addElement('autocomplete', 'selectedusers'.$id.$popuptype, 'Fragenersteller', $autocompleteoptions, $options);
    ...
    public function create_autocomplete_single_select_html($autocompleteoptions, $id=null, $popuptype=null) {
        ...
        $element = $this->_form->addElement('autocomplete', 'selectedusers'.$id.$popuptype, 'Fragenersteller', $newautocompleteoptions);
        return $element->toHtml();
        // how to use example: enrol_users_form has this code:
    }
}
