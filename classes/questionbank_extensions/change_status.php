...
require_once($CFG->dirroot . '/blocks/exaquest/classes/output/popup_change_status.php');
require_once($CFG->dirroot . '/blocks/exaquest/classes/output/popup_change_status_primary_button.php');
require_once($CFG->dirroot . '/blocks/exaquest/classes/output/popup_change_status_secondary_button.php');
    ...
    public static function get_content_static($question): string {
        ...
        switch (intval($question->teststatus)) {
            ...
            case BLOCK_EXAQUEST_QUESTIONSTATUS_TO_REVISE:
                ...
                //echo '<a href="#" class="exaquest-changequestionstatus changestatus'.$question->questionbankentryid.' btn btn-primary btn-sm" role="button" value="open_question_for_review"> '.get_string('open_question_for_review', 'block_exaquest').'</a>';
                break;
