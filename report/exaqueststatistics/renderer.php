...
//
///**
// * Defines the renderer for the quiz_exaqueststatistics module.
// *
...
//
///**
// * The renderer for the quiz_exaqueststatistics module.
// *
// * @copyright  2018 Huong Nguyen <huongnv13@gmail.com>
// * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
// */
//class quiz_exaqueststatistics_renderer extends plugin_renderer_base {
//
//    /**
...
//        return $this->notification(get_string('nothingfound', 'quiz_exaqueststatistics'));
//    }
//
//    /**
...
//        $output = '';
//
//        $output .= $this->heading(get_string('questionsthatneedgrading', 'quiz_exaqueststatistics'), 3);
...
//                            $gradequestionurl,
//                            get_string($gradestring, 'quiz_exaqueststatistics'),
...
//     * @param quiz_exaqueststatistics_settings_form $filterform Question filter form.
...
//
//        $output .= $this->heading(get_string('gradingquestionx', 'quiz_exaqueststatistics', $questioninfo), 3);
//
//        $output .= html_writer::tag('p', html_writer::link($listquestionsurl,
//                get_string('backtothelistofquestions', 'quiz_exaqueststatistics')),
//                ['class' => 'mdl-align']);
//
//        $output .= $filterform->render();
//
//        $output .= $this->heading(get_string('gradingattemptsxtoyofz', 'quiz_exaqueststatistics', $paginginfo), 3);
//
...
//                'value' => get_string('saveandnext', 'quiz_exaqueststatistics')
//        ]), ['class' => 'mdl-align']);
